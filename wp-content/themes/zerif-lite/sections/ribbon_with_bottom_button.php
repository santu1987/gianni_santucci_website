...
if ( ! empty( $zerif_bottomribbon_text ) ) :
	...
	if ( ! empty( $zerif_bottomribbon_buttonlabel ) && ! empty( $zerif_bottomribbon_buttonlink ) ) :
		...
		echo '<a href="' . esc_url( $zerif_bottomribbon_buttonlink ) . '" class="btn btn-primary custom-button green-btn" target="_blank">' . wp_kses_post( $zerif_bottomribbon_buttonlabel ) . '</a>';
