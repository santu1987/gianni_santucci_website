...
if ( ! empty( $zerif_ribbonright_text ) ) {
	...
	if ( ! empty( $zerif_ribbonright_buttonlabel ) && ! empty( $zerif_ribbonright_buttonlink ) ) {
		...
		echo '<a href="' . esc_url( $zerif_ribbonright_buttonlink ) . '" class="btn btn-primary custom-button red-btn" target="_blank">' . wp_kses_post( $zerif_ribbonright_buttonlabel ) . '</a>';
