       ...
       <!--
        ...
        <section class="lo-portfolio" id="lo-team">
        ...
        <section class="lo-acvhivement image-bg fog-con"  style="<?php echo $banner_tops; ?>" >
            <div class="">
        ...
        =================== 
        -->
        <section class="lo-pricing-plan" id="lo-pricing">
            <div class="container">
                <div class="row relative section-separator">
					<?php
        ...
        =================== 
        -->
        <section class="lo-contact " id="lo-contact">
